...
Example test_nonzeros:
  ...
  (* FILL IN HERE *) simpl. reflexivity.
Qed.
...
*)
(* FILL IN HERE *)
Theorem bag_count_sum : ∀ n : nat, ∀ s1 s2 : bag, count n s1 + count n s2 = count n (sum s1 s2).
Proof.
  intros n s1 s2.
  induction s1 as [| e s1' IHs1'].
  - simpl. reflexivity.
  - simpl. destruct (n =? e).
...
Qed.  
(* other proof: transitivity f (f n1).를 할 수도 있음 *)
(** [] *)

(** **** Exerciseㄴ: 2 stars, advanced (rev_injective)
